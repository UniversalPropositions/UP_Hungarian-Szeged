...
- `git clone https://github.com/UniversalPropositions/UP_Hungarian-Szeged.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Hungarian-Szeged>/ --input_up=<up_path_to_UP_Hungarian-Szeged>/ --output=<path_to_UD+UP_Hungarian-Szeged>/`
